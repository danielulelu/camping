  ...
  return (
    <section className="max-container padding-container flex flex-col gap-20 py-20 pb-32 md:gap-28 xl:flex-row">
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        />
        <h1 className="bold-52 lg:bold-58 pt-4 md:pt-8">
      ...
      <div className="relative flex flex-1 items-start">
        <div className="relative z-18 flex w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">

          <div className="flex flex-col">
            <div className="flexBetween">
              <p className="regular-16 text-gray-20 mt-0">Location</p>
          ...
          <div className="flexBetween">
            ...
            <div className="flex flex-col">
              ...
              <p className="bold-20 text-white">2 kms</p>
            </div>            
          </div>
